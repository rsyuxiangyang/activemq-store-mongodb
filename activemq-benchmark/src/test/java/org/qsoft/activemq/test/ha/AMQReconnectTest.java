...
import org.qsoft.activemq.util.Wait;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class AMQReconnectTest extends TestCase {

    public static final int MESSAGES_PER_ITTERATION = 1;
    public static final int WORKER_COUNT = 1;

    private static final Logger LOG = LoggerFactory.getLogger(AMQReconnectTest.class);
